...
const displayAlbum = async () => {
  let data = await fetch("https://music-webapp.infinityfreeapp.com/Albums");
  ...
  for (let index = 0; index < anchors.length; index++) {
    ...
    if (e.href.includes("/Albums/")) {
      ...
      let json_file = await fetch(
        `https://music-webapp.infinityfreeapp.com/Albums/${folder}/text.json`
      );
      ...
      cardcontainer.innerHTML =
        cardcontainer.innerHTML +
        `<div class="card">
        <img src="https://music-webapp.infinityfreeapp.com/Albums/${folder}/cover.jpg" alt="Cover" width="180" height="190">
        <div class="play-icon">
...
const displaysongs = async (e) => {
  ...
  let songsUL = await fetch(`https://music-webapp.infinityfreeapp.com/Albums/${card_name}`);
  ...
  let song_ul =
    `https://music-webapp.infinityfreeapp.com/Albums/${card_name}/` +
