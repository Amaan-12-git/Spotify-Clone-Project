...
const displayAlbum = async () => {
  let data = await fetch("https://github.com/Amaan-12-git/Spotify-Clone-Project/Albums");
  ...
  for (let index = 0; index < anchors.length; index++) {
    ...
    if (e.href.includes("/Albums/")) {
      ...
      let json_file = await fetch(
        `https://github.com/Amaan-12-git/Spotify-Clone-Project/Albums/${folder}/text.json`
      );
      ...
      cardcontainer.innerHTML =
        cardcontainer.innerHTML +
        `<div class="card">
        <img src="https://github.com/Amaan-12-git/Spotify-Clone-Project/Albums/${folder}/cover.jpg" alt="Cover" width="180" height="190">
        <div class="play-icon">
...
const displaysongs = async (e) => {
  ...
  let songsUL = await fetch(`https://github.com/Amaan-12-git/Spotify-Clone-Project/${card_name}`);
  ...
  let song_ul =
    `https://github.com/Amaan-12-git/Spotify-Clone-Project/Albums/${card_name}/` +
...
const display_folder =  async (card_name) =>{
  let songsUL = await fetch(`https://github.com/Amaan-12-git/Spotify-Clone-Project/Albums/${card_name}`);
  let songs_text = await songsUL.text();
  let songs_div = document.createElement("div");
  songs_div.innerHTML = songs_text;
  let songcontainer = document.querySelector(".songcontainer");
