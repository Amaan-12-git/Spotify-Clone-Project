...
const displayAlbum = async () => {
  let data = await fetch("https://fantastic-marzipan-32dc4b.netlify.app/Albums");
  ...
  for (let index = 0; index < anchors.length; index++) {
    ...
    if (e.href.includes("/Albums/")) {
      ...
      let json_file = await fetch(
        `https://fantastic-marzipan-32dc4b.netlify.app/Albums/${folder}/text.json`
      );
      ...
      cardcontainer.innerHTML =
        cardcontainer.innerHTML +
        `<div class="card">
        <img src="https://fantastic-marzipan-32dc4b.netlify.app/Albums/${folder}/cover.jpg" alt="Cover" width="180" height="190">
        <div class="play-icon">
...
const displaysongs = async (e) => {
  ...
  let songsUL = await fetch(`https://fantastic-marzipan-32dc4b.netlify.app/Albums/${card_name}`);
  ...
  let song_ul =
    `https://fantastic-marzipan-32dc4b.netlify.app/Albums/${card_name}/` +
